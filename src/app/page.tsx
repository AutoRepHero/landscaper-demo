      ...
      <main>
        ...
        <section className="py-20 px-6 bg-white">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300">
                <div className="h-48 overflow-hidden">
                  <img src="/images/service-lawn.jpg" alt="Lawn Care" className="w-full h-full object-cover hover:scale-110 transition-transform duration-500" />
                </div>
                <div className="p-6">
                  <h3 className="font-heading text-xl font-bold text-brand-dark mb-2">Lawn Care</h3>
                  ...
                  <Link href="/services" className="text-brand-green font-semibold hover:text-brand-dark transition-colors inline-flex items-center">
              ...
              <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300">
                <div className="h-48 overflow-hidden">
                  <img src="/images/service-design.jpg" alt="Landscape Design" className="w-full h-full object-cover hover:scale-110 transition-transform duration-500" />
                </div>
                <div className="p-6">
                  <h3 className="font-heading text-xl font-bold text-brand-dark mb-2">Landscape Design</h3>
              ...
              <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300">
                <div className="h-48 overflow-hidden">
                  <img src="/images/service-hardscape.jpg" alt="Hardscaping" className="w-full h-full object-cover hover:scale-110 transition-transform duration-500" />
                </div>
                <div className="p-6">
                  <h3 className="font-heading text-xl font-bold text-brand-dark mb-2">Hardscaping</h3>
              ...
              <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300">
                <div className="h-48 overflow-hidden">
                  <img src="/images/service-irrigation.jpg" alt="Irrigation Systems" className="w-full h-full object-cover hover:scale-110 transition-transform duration-500" />
                </div>
                <div className="p-6">
                  <h3 className="font-heading text-xl font-bold text-brand-dark mb-2">Irrigation Systems</h3>
              ...
              <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300">
                <div className="h-48 overflow-hidden">
                  <img src="/images/service-snow.jpg" alt="Snow Removal" className="w-full h-full object-cover hover:scale-110 transition-transform duration-500" />
                </div>
                <div className="p-6">
                  <h3 className="font-heading text-xl font-bold text-brand-dark mb-2">Snow Removal</h3>
              ...
              <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300">
                <div className="h-48 overflow-hidden">
                  <img src="/images/service-trees.jpg" alt="Tree and Shrub Care" className="w-full h-full object-cover hover:scale-110 transition-transform duration-500" />
                </div>
                <div className="p-6">
                  <h3 className="font-heading text-xl font-bold text-brand-dark mb-2">Tree &amp; Shrub Care</h3>
            ...
            <div className="text-center mt-12">
              <Link href="/services" className="inline-block bg-brand-green text-white font-semibold px-8 py-3 rounded-xl hover:bg-brand-dark transition-colors">
                View All Services
              </Link>
            </div>
          </div>
        ...
        <section className="py-20 px-6 bg-brand-light/30">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
              Don&#39;t just take our word for it — hear from our satisfied customers throughout the Spokane area.
            </p>
        ...
        <section className="bg-brand-green py-16 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-brand-light text-lg mb-8 max-w-2xl mx-auto">
              Get a free, no-obligation estimate for your landscaping project. We serve Spokane and surrounding areas.
            </p>
            <Link href="/contact" className="inline-block bg-brand-gold text-white font-semibold px-8 py-4 rounded-xl hover:bg-brand-gold/90 transform hover:-translate-y-1 transition-all duration-300 shadow-lg">
        ...
        <section className="py-20 px-6 bg-white">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              We provide professional landscaping services throughout Spokane County and the surrounding communities.
            </p>
            <div className="flex flex-wrap justify-center gap-3">
              <span className="bg-brand-light text-brand-dark px-4 py-2 rounded-full text-sm font-medium">📍 Spokane</span>
              <span className="bg-brand-light text-brand-dark px-4 py-2 rounded-full text-sm font-medium">📍 Spokane Valley</span>
              <span className="bg-brand-light text-brand-dark px-4 py-2 rounded-full text-sm font-medium">📍 Liberty Lake</span>
              <span className="bg-brand-light text-brand-dark px-4 py-2 rounded-full text-sm font-medium">📍 Cheney</span>
              <span className="bg-brand-light text-brand-dark px-4 py-2 rounded-full text-sm font-medium">📍 Airway Heights</span>
              <span className="bg-brand-light text-brand-dark px-4 py-2 rounded-full text-sm font-medium">📍 Mead</span>
              <span className="bg-brand-light text-brand-dark px-4 py-2 rounded-full text-sm font-medium">📍 Millwood</span>
              <span className="bg-brand-light text-brand-dark px-4 py-2 rounded-full text-sm font-medium">📍 Deer Park</span>
            </div>
          </div>
        </section>
      </main>
